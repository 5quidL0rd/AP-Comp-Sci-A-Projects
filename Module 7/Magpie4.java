...
else if (findKeyword(statement, "I", 0) >= 0)
{
    ...
    int positionOfWant = findKeyword(statement, "want", positionOfI + 1);

    String restOfStatement = statement.substring(positionOfI + 7).trim();
 ...
 private String transformIYouStatement(String statement)
{
    ...
    String[] responses = {"Interesting, tell me more.","Hmmm.","Do you really think so?","You don't say.","The more you know.","That's odd."};
